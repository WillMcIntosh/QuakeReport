...
public final class QueryUtils {
     ...
     */
    private static List<Earthquake> extractFeatureFromJson(String
                                                                 earthquakeJson) {
        ...
        try {
            ...
            // catch the exception here, so the app doesn't crash. Print a
            // log message
    ...
    /**
     * Make HTTP request to a given URL and return a String response.
     */
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            // if the request was successful then read the input stream and
            // parse the response
            ...
            if (urlConnection.getResponseCode() == 200) {
                ...
                Log.e(LOG_TAG, "Error response code: " + urlConnection
                        .getResponseCode());
            }
        } catch (IOException e) {
